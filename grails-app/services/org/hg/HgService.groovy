...
class HgService {
    ...
    def getTenantTest(){
        ...
        vendor.put("code", "hg")
        vendor.put("name", "Hyper Gateway")
        vendor.put("description", "Hyper Gateway is an LTI broker for implementing generic LTI tool providers")
        vendor.put("url", "http://www.123it.ca/hg/")
        vendor.put("contact", "contact@123it.ca")
        tTest.put("vendor", vendor)
        Map<String, Object> product = new LinkedHashMap<String, Object>()
        product.put("code", "hg_test")
        product.put("name", "HG Test")
        product.put("description", "Default broker for processing test LTI (1.x and 2.x) requests")
        product.put("url", "http://hg.123it.ca/")
        product.put("contact", "contact@123it.ca")
        tTest.put("product", product)
