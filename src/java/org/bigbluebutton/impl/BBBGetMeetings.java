...
public class BBBGetMeetings implements BBBCommand {

    private static final Logger log = Logger.getLogger(BBBGetMeetings.class);

    private static final String ACTION = "Get recordings";

    public BBBGetMeetings(BBBProxy proxy, Map<String, String> params){
        this.proxy = proxy;
        this.params = params;
    }

    private String getURL(){
        String url = proxy.getGetMeetingsURL();
        return url;
    }
