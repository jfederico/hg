...
public interface LTI {
    ...
    public static final String VERSION_V1P0 = "LTI-1p0";
    public static final String VERSION_V2P0 = "LTI-2p0";
    ...
    * The Tool Provider should be flexible when parsing this field.  This parameter is optional but recommended.
    ...
    public static final String[] validPropertyNames = {
        CONTEXT_ID, CONTEXT_LABEL, CONTEXT_TITLE, CONTEXT_TYPE,
    ...
    public static final String[] LTI_V1_LAUNCH_REQUEST_PARAMETERS_REQUIRED = {
        LTI_MESSAGE_TYPE, LTI_VERSION, RESOURCE_LINK_ID
        };

    public static final String[] LTI_V1_LAUNCH_REQUEST_PARAMETERS_RECOMMENDED = {
        CONTEXT_ID,
        LAUNCH_PRESENTATION_DOCUMENT_TARGET, LAUNCH_PRESENTATION_HEIGHT,
    ...
    public static final String[] LTI_V1_LAUNCH_REQUEST_PARAMETERS_OPTIONAL = {
        CONTEXT_TYPE,
    ...
    public static final String[] LTI_V2_LAUNCH_REQUEST_PARAMETERS_REQUIRED = {
        LTI_MESSAGE_TYPE, LTI_VERSION, RESOURCE_LINK_ID
        };

    public static final String[] LTI_V2_LAUNCH_REQUEST_PARAMETERS_RECOMMENDED = {
        CONTEXT_ID,
        LAUNCH_PRESENTATION_DOCUMENT_TARGET, LAUNCH_PRESENTATION_HEIGHT,
        LAUNCH_PRESENTATION_RETURN_URL, LAUNCH_PRESENTATION_WIDTH,
        ROLES, TOOL_CONSUMER_INSTANCE_GUID, USER_ID
    ...
    public static final String[] LTI_V2_LAUNCH_REQUEST_PARAMETERS_OPTIONAL = {
        CONTEXT_TYPE,
        LAUNCH_PRESENTATION_LOCALE, LAUNCH_PRESENTATION_CSS_URL, 
        ROLE_SCOPE_MENTOR, USER_IMAGE
        };

    public static final String[] LTI_V2_TOOL_PROXY_REGISTRATION_REQUEST_PARAMETERS_REQUIRED = {
        LTI_MESSAGE_TYPE, REG_KEY, REG_PASSWORD, TC_PROFILE_URL, LAUNCH_PRESENTATION_RETURN_URL 
        };

    public static final String[] LTI_V2_TOOL_PROXY_REGISTRATION_REQUEST_PARAMETERS_RECOMMENDED = {
        LAUNCH_PRESENTATION_DOCUMENT_TARGET, LAUNCH_PRESENTATION_HEIGHT,
        LAUNCH_PRESENTATION_RETURN_URL, LAUNCH_PRESENTATION_WIDTH,
        ROLES, USER_ID
        };

    public static final String[] LTI_V2_TOOL_PROXY_REGISTRATION_REQUEST_PARAMETERS_OPTIONAL = {
        LAUNCH_PRESENTATION_LOCALE, LAUNCH_PRESENTATION_CSS_URL, 
        };
