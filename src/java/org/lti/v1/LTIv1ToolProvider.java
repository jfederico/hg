...
public class LTIv1ToolProvider extends LTIToolProvider implements LTIv1 {

    private static final Logger log = Logger.getLogger(LTIv1ToolProvider.class);

    public LTIv1ToolProvider(String endpoint, String key, String secret, Map<String, String> params)
    ...
    public String getProductFamilyCode() {
        String productFamilyCode = this.params.containsKey(TOOL_CONSUMER_INFO_PRODUCT_FAMILY_CODE)? this.params.get(TOOL_CONSUMER_INFO_PRODUCT_FAMILY_CODE): "default";
